...
def connsql(month):
    ...
    sql = '''SELECT
            ...
            WHERE
                   MONTH(bpm_approve_opinion.create_time) = '%d'
...
def analysis(data):
    ...
    data.rename(columns={'apply_title': '申请名称', 'apply_real_name': '实际申请人','apply_dept_name': '申请人部门','apply_company_name': '申请人公司名称','process_name': '审核名称',
                         'apply_status': '申请状态','op_cby': '申请创建人','op_ctime': '申请创建时间','op_uby': '申请修改人','op_utime': '申请修改时间',
                         'flow_type': '流程类型','task_name': '审批','approve_opinion': '审批意见','cby': '审批人员','ctime': '审批时间','uby': '审批修改人','utime': '审批修改时间'}, inplace=True)
    print(data)
